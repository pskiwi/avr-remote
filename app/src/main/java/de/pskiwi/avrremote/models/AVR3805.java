...
public class AVR3805 extends AbstractModel {
	...
	public Selection getInputSelection(ModelArea area) {
		...
		b.add("TUNER");
		b
				.add("DVD", "VDP", "TV", "DBS/SAT", "VCR-1", "VCR-2", "VCR-3",
						"V.AUX");
		b.add("CDR/TAPE1", "MD/TAPE2");
		return b.create();
	}
	...
	public Selection getVideoSelection(ModelArea area) {
		return new Selection("DVD", "VDP", "TV", "DBS/SAT", "VCR-1", "VCR-2",
				"VCR-3", "SOURCE", "V.AUX");
	}
